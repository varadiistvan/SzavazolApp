    ...
    return(
        <SafeAreaView style={{
            ...
            <ScrollView style={{width: '100%'}}>
                ...
                <Pressable style={{flexDirection: 'row', alignItems: 'center'}} onPress={() => navigation.navigate("How")}>
                    <Text style={{paddingVertical: 5}}>Mit kell tudni a választásokról?</Text>
                    <Icon style={{paddingVertical: 5}} name="chevron-right" />
                </Pressable>
                <Pressable style={{flexDirection: 'row', alignItems: 'center'}} onPress={() => navigation.navigate("Who")}>
