...
export const Quiz = ({ navigation }: QuizProps) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 10; i++) {
      kérdésekConstructor.push({
        kérdés: "Valamilyen kvízkérdés",
        válaszok: [
          { szöveg: "Jó válasz", jó: true },
          { szöveg: "Rossz válasz", jó: false },
          { szöveg: "Rossz válasz", jó: false },
        ],
      })
    }
      ...
      >
              ...
              <View key={index} style={{ width: "100%", alignItems: "center" }}>
                <Pressable
                  ...
                  onPress={() => {
                    if (selected === null) {
                      setSelected(index)
                      setPontszám((lastValue) =>
                        item.jó ? lastValue + 100 : lastValue,
                      )
                    }
                  }}
                >
                  ...
                  <Text>
                    {selected === index ? (item.jó ? "+100" : "+0") : null}
                  </Text>
                </Pressable>
              </View>
            )
        ...
        <View style={{ flex: 1 }}>
          <ProgressBar
            ...
            height={20}
            borderRadius={30}
            progress={currentQuestion / kérdések.length}
          />
        </View>
